...
use Dsc\Admin\Forms\ProfilesForm;
use Dsc\Admin\Models\Profiles;

/**
 * Dsc\Admin\Controllers\ProfilesController
 * CRUD to manage profiles
 */
class ProfilesController extends Base
{
    ...
    public function searchAction()
    {
        ...
        if ($this->request->isPost()) {
            $query = Criteria::fromInput($this->di, 'Dsc\Admin\Models\Profiles', $this->request->getPost());
